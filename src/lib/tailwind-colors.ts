...
export const TAILWIND_COLORS: TailwindColor[] = [
  ...
  },
  {
    name: "Zinc",
    shades: [
      { shade: 50, hex: "#FAFAFA" }, { shade: 100, hex: "#F4F4F5" }, { shade: 200, hex: "#E4E4E7" },
      { shade: 300, hex: "#D4D4D8" }, { shade: 400, hex: "#A1A1AA" }, { shade: 500, hex: "#71717A" },
      { shade: 600, hex: "#52525B" }, { shade: 700, hex: "#3F3F46" }, { shade: 800, hex: "#27272A" },
      { shade: 900, hex: "#18181B" }, { shade: 950, hex: "#09090B" },
    ],
  },
  {
    name: "Neutral",
    shades: [
      { shade: 50, hex: "#FAFAFA" }, { shade: 100, hex: "#F5F5F5" }, { shade: 200, hex: "#E5E5E5" },
      { shade: 300, hex: "#D4D4D4" }, { shade: 400, hex: "#A3A3A3" }, { shade: 500, hex: "#737373" },
      { shade: 600, hex: "#525252" }, { shade: 700, hex: "#404040" }, { shade: 800, hex: "#262626" },
      { shade: 900, hex: "#171717" }, { shade: 950, hex: "#0A0A0A" },
    ],
  },
  {
    name: "Stone",
    shades: [
      { shade: 50, hex: "#FAFAF9" }, { shade: 100, hex: "#F5F5F4" }, { shade: 200, hex: "#E7E5E4" },
      { shade: 300, hex: "#D6D3D1" }, { shade: 400, hex: "#A8A29E" }, { shade: 500, hex: "#78716C" },
      { shade: 600, hex: "#57534E" }, { shade: 700, hex: "#44403C" }, { shade: 800, hex: "#292524" },
      { shade: 900, hex: "#1C1917" }, { shade: 950, hex: "#0C0A09" },
    ],
  },
  {
    name: "Red",
  ...
  },
  {
    ...
    shades: [
      ...
      { shade: 900, hex: "#581C87" }, { shade: 950, hex: "#3B0764" },
    ],
  },
  {
    name: "Fuchsia",
    shades: [
      { shade: 50, hex: "#FDF4FF" }, { shade: 100, hex: "#FAE8FF" }, { shade: 200, hex: "#F5D0FE" },
      { shade: 300, hex: "#F0ABFC" }, { shade: 400, hex: "#E879F9" }, { shade: 500, hex: "#D946EF" },
      { shade: 600, hex: "#C026D3" }, { shade: 700, hex: "#A21CAF" }, { shade: 800, hex: "#86198F" },
      { shade: 900, hex: "#701A75" }, { shade: 950, hex: "#4A044E" },
    ],
  },
  {
    name: "Pink",
